  ...
  return (
    <section className="about-the-class">
      <div className="about-the-class-text">
        ...
        <p>In June 2020, our fearless Teensway artists braved the global coronavirus pandemic and the perils of online video-chat software to attend. Over the course of our brief time together, we laughed, learned, talked about syzygies, and created this collection of wonderful webcomics together. We hope you enjoy them.</p>
      </div>
